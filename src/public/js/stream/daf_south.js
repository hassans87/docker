...
$('#chr_title').attr('value', 'DAF South Line Feed Flow');
queryStream();
}
...
$('#chr_title').attr('value', 'DAF South Line Spray Block Balloon Pressure');
queryStream();
}
...
$('#chr_title').attr('value', 'DAF South Line PCV');
queryStream();
}
...
var stack2=["a_spray_pres","b_spray_pres","c_spray_pres","d_spray_pres","e_spray_pres","f_spray_pres","daf_inletline_pres"];
var stack3 = ["ferric_flow_tot"];
var stack4=["daf_inlet_turbidity","daf_flr_turb"];
var stack5=["a_flow","b_flow","c_flow","d_flow","e_flow","f_flow","daf_inlet_tot_flow","daf_cal_tot_flow"];
var stack6=["north_sdi","south_sdi"];
var stack7=["daf_inlet_orp"];
var stack8=["working_daf"];
...
var axis_Y4 =(s1Param.isY && (stack4.includes(s1Param.ufData))||s2Param.isY && (stack4.includes(s2Param.ufData))||s3Param.isY && (stack4.includes(s3Param.ufData))||s4Param.isY && (stack4.includes(s4Param.ufData))||s5Param.isY && (stack4.includes(s5Param.ufData))||s6Param.isY && (stack4.includes(s6Param.ufData))||s7Param.isY && (stack4.includes(s7Param.ufData)))? true: false; 
   var axis_Y5 =(s1Param.isY && (stack5.includes(s1Param.ufData))||s2Param.isY && (stack5.includes(s2Param.ufData))||s3Param.isY && (stack5.includes(s3Param.ufData))||s4Param.isY && (stack5.includes(s4Param.ufData))||s5Param.isY && (stack5.includes(s5Param.ufData))||s6Param.isY && (stack5.includes(s6Param.ufData))||s7Param.isY && (stack5.includes(s7Param.ufData)))? true: false; 
    ...
    var axis_Y14=(s1Param.isY && (stack14.includes(s1Param.ufData))||s2Param.isY && (stack14.includes(s2Param.ufData))||s3Param.isY && (stack14.includes(s3Param.ufData))||s4Param.isY && (stack14.includes(s4Param.ufData))||s5Param.isY && (stack14.includes(s5Param.ufData))||s6Param.isY && (stack14.includes(s6Param.ufData))||s7Param.isY && (stack14.includes(s7Param.ufData)))? true: false; 
    let confYaxis  = {
...
Highcharts.seriesTypes.scatter.prototype.noSharedTooltip = false;
       ...
       // url: "http://localhost:7801",
        ...
        filename:'SWRO-SADARA DAF South'+ ' '+datex[0] + ' hrs  To: '+datex[datex.length-1]+' hrs' ,
        enabled: true,
        buttons: {
            contextButton: {
                align: 'right',
