...
var stack1=["blending_temp"];
var stack2=["blending_ec"];
var stack3 = ["blending_ph"];
...
Highcharts.seriesTypes.scatter.prototype.noSharedTooltip = false;
       ...
       // url: "http://localhost:7801",
        ...
        filename:'SADARA-SWRO Blending_tank'+' '+datex[0] + " To "+datex[datex.length-1],
        enabled: true,
        buttons: {
            contextButton: {
                align: 'right',
