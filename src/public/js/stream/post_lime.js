...
const st = {
    ...
    sat1_lic_114: {
        unit: " %",
        name: "Saturator-1 Lime Water Level",
        yAxis: 0,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
    ...
    sat2_lic_214: {
        unit: " %",
        name: "Saturator-2 Lime Water Level",
        yAxis: 0,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
    ...
    sat3_lic_314: {
        unit: " %",
        name: "Saturator-3 Lime Water Level",
        yAxis: 0,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
    ...
    sat1_at_102: {
        unit: " mS/cm",
        name: "Saturator-1 Lime Water EC",
        yAxis: 2,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
    ...
    sat2_at_202: {
        unit: " mS/cm",
        name: "Saturator-2 Lime Water EC",
        yAxis: 2,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
    ...
    sat3_at_302: {
        unit: " mS/cm",
        name: "Saturator-3 Lime Water EC",
        yAxis: 2,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
    ...
    sat1_at_113: {
        unit: " NTU",
        name: "Saturator-1 Lime Water Turbidity",
        yAxis: 3,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
    ...
    sat2_at_213: {
        unit: " NTU",
        name: "Saturator-2 Lime Water Turbidity",
        yAxis: 3,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
    ...
    sat3_at_313: {
        unit: " NTU",
        name: "Saturator-3 Lime Water Turbidity",
        yAxis: 3,
        arrFlr: 0.5,
        valFixTo: 1,
        sum: false,
...
Highcharts.seriesTypes.scatter.prototype.noSharedTooltip = false;
       ...
       // url: "http://localhost:7801",
        ...
        filename:'SADARA-SWRO Post-Treatment Lime'+' '+datex[0] + " To "+datex[datex.length-1],
        enabled: true,
        buttons: {
            contextButton: {
                align: 'right',
