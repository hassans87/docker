...
Notiflix.Report.Failure('Query Warning','Series-'+series+' Data Array is empty!','Close');
...
var stack1=["spare"];
var stack2=["line1_press","line2_press","p1_pres","p2_pres","p3_pres","p4_pres","p5_pres"];
var stack3 = ["sbsflow_nl"];
var stack4=["sw_turbidity"];
var stack5=["sw_line1_flow","sw_line2_flow","p1_flow","p2_flow","p3_flow","p4_flow","p5_flow","daf_slflow"];
...
Highcharts.seriesTypes.scatter.prototype.noSharedTooltip = false;
        ...
        x:35,
        y:20, 
        text: 'Seawater Pumps Operation/Quality',
       ...
       // url: "http://localhost:7801",
        ...
        filename:'SWRO-SADARA SeaWater Quality'+ ' '+datex[0] + " To "+datex[datex.length-1],
        enabled: true,
        buttons: {
            contextButton: {
                align: 'right',
        ...
        states: {inactive: {opacity: 1}}
                       ...
                       style:{
                        ...
                        enabled: true,
                        //format: '{value}',
                        formatter: function() {return (this.value).toFixed(0)+"K";},                                     
                        style:{
                            color:'#1e272e',
                            fontWeight:'bold',
                            backgroundColor: '#000000',
