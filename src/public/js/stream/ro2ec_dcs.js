...
var stack2=["a_ait_109","b_ait_109","c_ait_109","d_ait_109","e_ait_112","a_at_112","b_at_112","c_at_112","d_at_112","e_at_112"];
var stack3 = ["brine_ph"];
...
Highcharts.seriesTypes.scatter.prototype.noSharedTooltip = false;
        ...
        title: {
            ...
            x:35,
            y:30, 
            text: 'RO Second Pass Conductivity',
       ...
       // url: "http://localhost:7801",
        ...
        filename:'SADARA-SWRO RO2_EC'+' '+datex[0] + " To "+datex[datex.length-1],
        enabled: true,
        buttons: {
            contextButton: {
                align: 'right',
