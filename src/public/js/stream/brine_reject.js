...
Highcharts.seriesTypes.scatter.prototype.noSharedTooltip = false;
       ...
       // url: "http://localhost:7801",
        ...
        filename:'SADARA-SWRO Brine Reject'+' '+datex[0] + " To "+datex[datex.length-1],
        enabled: true,
        buttons: {
            contextButton: {
                align: 'right',
