...
var stack1=["turb_lab","turb_a","turb_b"];
var stack2=["temp"];
var stack3 = ["ph_lab","ph_a","ph_b"]; 
var stack4=["frc_lab","frc_ait203a","frc_ait203b"];
var stack5=["ec","ec_a","ec_b"];
var stack6=["tds","cah","ca"];
var stack7=["lsi_lab"]; 
...
Highcharts.seriesTypes.scatter.prototype.noSharedTooltip = false;
        ...
        title: {
            ...
            x:35,
            y:30, 
            text: 'Demin Water Export Lab Analytics',
       ...
       // url: "http://localhost:7801",
        ...
        filename:'SADARA-SWRO DW_export'+' '+datex[0] + " To "+datex[datex.length-1],
        enabled: true,
        buttons: {
            contextButton: {
                align: 'right',
