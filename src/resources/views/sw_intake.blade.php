  ...
  <div class="col-auto" style="margin-right:5px;">
    <a href="{{ url('/home') }}"> 
      ...
      <div class="input-group-prepend">
        <div class="input-group-text badge-light3d mnbtn">From</div>
      </div>
       <input type="date" name="start_date" class="tensor-flow form-control form-control-sm" id="start_date" value="2023-03-01" min="2014-12-31" max="2023-12-31" required="" style="background-color:#dff9fb;">
    </div>
       </div>
      <div class="col-auto" style="margin-right:5px;">
            <div class="input-group">
            <div class="input-group-prepend">
            <div class="input-group-text badge-light3d mnbtn">To</div></div>
            <input type="date" name="end_date" id="end_date" value="2023-03-31" min="2014-12-31" max="2023-12-31" class="tensor-flow form-control form-control-sm" required="" style="background-color:#dff9fb;"> 
            </div>
      </div>
<div class="col-auto" style="margin-right:5px;">
    <div class="input-group">
    <div class="input-group-prepend">
    <div class="input-group-text badge-light3d mnbtn">Data Interval &nbsp;<i class="fa fa-clock-o" aria-hidden="true" style="color:black;"></i></div></div>
    <select class="query form-control form-control-sm form-select" id="invt" style="background-color:#dff9fb;">
      ...
      <div class="col-auto" style="margin-right:15px;">
              <div class="input-group">
              <button id="query_fire" class="query_fire btn btn-warning btn-md form-check">
