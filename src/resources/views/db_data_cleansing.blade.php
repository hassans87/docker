...
<head>
  ...
  <title>Data Cleansing Tool</title>
</head>
<body class="">
      <table class="table-borderless align-middle mb-0 mt-0">
            ...
            <tbody> 
            <tr >
              <td class="bdr"> <a href="{{url('DataCleansing/RO1DataCleansing')}}"  style="text-decoration: none;" class="menu">
              <button class="btn btn-light menu"> 🔬&nbsp; RO First Pass </button></a> 
              </td>
                <td >
