...
<title> Post-treatment Cl2 </title>
</head>
...
<figure id="plot_window" class="test_print loading-msg" style="height:93vh;"></figure>
  ...
  <option value="cl_wgt1" selected>56Z_WT_002X Cylinder-1 Weight</option>
  <option value="cl_wgt2">56Z_WT_202X Cylinder-2 Weight</option>
  <option value="cl_wgt3">56Z_WT_102X Cylinder-3 Weight</option>
  <option value="cl_wgt4">56Z_WT_302X Cylinder-4 Weight</option>
  <option value="mcv113_fb">56Z_MCV_113X (feedback) Line-1</option>
  <option value="mcv113_cmd">56Z_MCV_113X (command) Line-1</option>
  <option value="mcv313_fb">56Z_MCV_313X (feedback) CW Line-2</option>
  <option value="mcv313_cmd">56Z_MCV_313X (command) CW Line-2</option>
  <option value="fic113_flow">56Z_FIC_113X (PV) CW line-1</option>
  <option value="fic113_sp">56Z_FIC_113_XSP (SP) CW line-1</option>
  <option value="fic313_pv">56Z_FIC_313X (PV) CW Line-2 </option>
  <option value="fic313_cmd">56Z_FIC_313_XSP (SP) CW Line-2 </option>
  <option value="ft501_flow">56Z_FT_501X Line-1 Motive water flow</option>
  <option value="ft701_flow">56Z_FT_701X Line-2 Motive water flow</option>
  <option value="lt804_lvl">56Z_LT_804X NaOH tank level</option>
  ...
  <tr class="tr2 table-light">      
                  ...
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata2">
                    <option value="cl_wgt1" >56Z_WT_002X Cylinder-1 Weight</option>
                    <option value="cl_wgt2" selected>56Z_WT_202X Cylinder-2 Weight</option>
                    <option value="cl_wgt3">56Z_WT_102X Cylinder-3 Weight</option>
                    <option value="cl_wgt4">56Z_WT_302X Cylinder-4 Weight</option>
                    <option value="mcv113_fb">56Z_MCV_113X (feedback) Line-1</option>
                    <option value="mcv113_cmd">56Z_MCV_113X (command) Line-1</option>
  ...
  <tr class="tr3 table-light">      
                  ...
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata3">
                    <option value="cl_wgt1" >56Z_WT_002X Cylinder-1 Weight</option>
                    <option value="cl_wgt2" >56Z_WT_202X Cylinder-2 Weight</option>
                    <option value="cl_wgt3" selected>56Z_WT_102X Cylinder-3 Weight</option>
                    <option value="cl_wgt4">56Z_WT_302X Cylinder-4 Weight</option>
                    <option value="mcv113_fb">56Z_MCV_113X (feedback) Line-1</option>
                    <option value="mcv113_cmd">56Z_MCV_113X (command) Line-1</option>
                    <option value="mcv313_fb">56Z_MCV_313X (feedback) CW Line-2</option>
  ...
  <tr class="tr4 table-secondary">      
                  ...
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata4" style="display: none;">
                    ...
                    <option value="mcv313_fb">56Z_MCV_313X (feedback) CW Line-2</option>
                    <option value="mcv313_cmd">56Z_MCV_313X (command) CW Line-2</option>
                    <option value="fic113_flow" selected>56Z_FIC_113X (PV) CW line-1</option>
                    <option value="fic113_sp">56Z_FIC_113_XSP (SP) CW line-1</option>
                    <option value="fic313_pv">56Z_FIC_313X (PV) CW Line-2 </option>
                    <option value="fic313_cmd">56Z_FIC_313_XSP (SP) CW Line-2 </option>
                    <option value="ft501_flow">56Z_FT_501X Line-1 Motive water flow</option>
  ...
  <tr class="tr5 table-secondary">      
                  ...
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata5" style="display: none;">
                    ...
                    <option value="fic113_flow" >56Z_FIC_113X (PV) CW line-1</option>
                    <option value="fic113_sp">56Z_FIC_113_XSP (SP) CW line-1</option>
                    <option value="fic313_pv" selected>56Z_FIC_313X (PV) CW Line-2 </option>
                    <option value="fic313_cmd">56Z_FIC_313_XSP (SP) CW Line-2 </option>
                    <option value="ft501_flow">56Z_FT_501X Line-1 Motive water flow</option>
                    <option value="ft701_flow">56Z_FT_701X Line-2 Motive water flow</option>
                    <option value="lt804_lvl">56Z_LT_804X NaOH tank level</option>
  ...
  <tr class="tr6 table-secondary">      
                  ...
                  <select class="query form-control form-control-sm form-select" id="ufdata6" style="display: none;">
                    ...
                    <option value="ft501_flow">56Z_FT_501X Line-1 Motive water flow</option>
                    <option value="ft701_flow">56Z_FT_701X Line-2 Motive water flow</option>
                    <option value="lt804_lvl" selected>56Z_LT_804X NaOH tank level</option>
                      </select>
                  </div> </div>
                 </td><td style="text-align: center;">
  ...
  <tr class="tr7 table-secondary">      
                  ...
                  <select class="query form-control form-control-sm form-select" id="ufdata7" style="display: none;">
                    ...
                    <option value="fic313_pv" >56Z_FIC_313X (PV) CW Line-2 </option>
                    <option value="fic313_cmd">56Z_FIC_313_XSP (SP) CW Line-2 </option>
                    <option value="ft501_flow" selected>56Z_FT_501X Line-1 Motive water flow</option>
                    <option value="ft701_flow">56Z_FT_701X Line-2 Motive water flow</option>
                    <option value="lt804_lvl" >56Z_LT_804X NaOH tank level</option>
                  </select>
                  </div> </div>
  ...
  <script type="text/javascript" src="{{asset('js/stream/post_cl2.js') }}"></script>
