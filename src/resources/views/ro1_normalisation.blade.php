  ...
  <div class="col-auto" style="margin-right:5px;">
    <a href="{{ url('/home') }}">
      ...
      <div class="col-auto" style="margin-right:5px;">
            ...
            <input type="date" name="end_date" id="end_date" value="2023-03-30" min="2016-01-31" max="2027-03-30" class="tensor-flow form-control form-control-sm" required="" style="background-color:#dff9fb;">
            </div>
      </div>
