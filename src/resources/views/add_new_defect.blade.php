  ...
  width:30%;
    ...
    <form class="" method="POST" action="newDefectSubmission" enctype="multipart/form-data">
      ...
      <div class="row g-3">
        ...
        <div class="col-sm-4">
          <label for="equipment" class="form-label">Equipment (Pump, HOV ..)</label>
          <div class="input-group has-validation">
            <span class="input-group-text"><i class ="fa fa-cogs" aria-hidden="true"></i></span>
            <input type="text" class="form-control form-control-sm" name="equipment" id="equipment" required="" value="{{old('equipment')}}">
          </div>
          @error('equipment')
        ...
        <div class="col-sm-4">
          <label for="tag" class="form-label">Tag (SWRO-41Z-P-100)</label>
          <div class="input-group has-validation">
            <span class="input-group-text"><i class ="fa fa-tag" aria-hidden="true"></i></span>
            <input type="text" class="form-control form-control-sm" name="tag" id="tag" required="" value="{{old('tag')}}">
          </div>
          @error('tag')
          <p class="text-danger">{{$message}}</p>
          @enderror
        ...
        <div class="col-sm-4">
          <label for="name" class="form-label">Sub-Zone (41A)</label>
          <div class="input-group has-validation">
            <span class="input-group-text"><i class ="fa fa-map-pin" aria-hidden="true"></i></span>
            <input type="text" class="form-control form-control-sm" name="subzone" id="subzone" required="" value="{{old('subzone') }}">
          </div>
          @error('subzone')
          <p class="text-danger">{{$message}}</p>
          @enderror
        ...
        <div class="col-sm-4">
          <label for="eventdate" class="form-label">Equipment Type (P, POV, HOV)</label>
          <div class="input-group has-validation">
            <span class="input-group-text"><i class ="fa fa-cog" aria-hidden="true"></i></span>
            <input type="text" class="form-control form-control-sm" name="equipment_type" id="equipment_type" required="" value="{{old('equipment_type')}}">
          </div>
        ...
        <div class="col-sm-4">
          <label for="eventdate" class="form-label">Equipment Number (001)</label>
          <div class="input-group has-validation">
            <span class="input-group-text"><i class ="fa fa-cube" aria-hidden="true"></i></span>
            <input type="text" class="form-control form-control-sm" name="equipment_number" id="equipment_number" required="" value="{{old('equipment_number')}}">
          </div>
        ...
        <div class="col-sm-4">
          <label for="pidnumber" class="form-label">PID Number (SWRO-41A-PID001)</label>
          <div class="input-group has-validation">
            <span class="input-group-text"><i class ="fa fa-map" aria-hidden="true"></i></span>
            <input type="text" class="form-control form-control-sm" name="pidnumber" id="pidnumber" required="" value="{{old('pidnumber')}}">
          </div>
           @error('pidnumber')
          <p class="text-danger">{{$message}}</p>
          @enderror
        ...
        <div class="col-sm-4">
          ...
          <div class="input-group has-validation">
            ...
            <input type="text" class="form-control form-control-sm" name="raised_by" id="raised_by" required="" value="{{Auth::user()->name;}}">
          </div>
          @error('raised_by')
          <p class="text-danger">{{$message}}</p>
          @enderror
        ...
        <div class="col-sm-4">
          ...
          <div class="input-group has-validation">
            ...
            <input type="date" class="form-control form-control-sm" name="event_date" id="event_date" required="" value="{{old('event_date')}}">
          </div>
          @error('event_date')
          <p class="text-danger">{{$message}}</p>
          @enderror
        ...
        <div class="col-sm-12">
          <label for="desciption" class="form-label">Defect Description</label>
          <div class="input-group has-validation">
            <span class="input-group-text"><i class ="fa fa-pencil-square-o" aria-hidden="true"></i></span>
            <textarea rows="8"  class="form-control form-control-sm" name="desciption" id="desciption" required="">{{old('desciption')}}</textarea>
            @error('desciption')
          <p class="text-danger">{{$message}}</p>
          @enderror
          </div>
      ...
      <button class="btn btn-dark btn-sm" type="reset">🗑️ &nbsp;Clear Form</button>
    </form>
    </div>
