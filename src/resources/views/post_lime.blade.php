...
<title> Post-treatment Lime </title>
</head>
...
<figure id="plot_window" class="test_print loading-msg" style="height:93vh;"></figure>
  ...
  <select class="query form-control form-control-sm form-select" id="ufdata1">
    ...
    <option value="sat2_at_202" >Saturator-2 Lime Water Conductivity</option>
    <option value="sat2_at_213" >Saturator-2 Lime Water Turbidity </option>
    <option value="sat2_lic_214" >Saturator-2 Lime Water Tank Level</option>
  ...
  <tr class="tr2 table-light">      
                  ...
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata2">
                    <option value="silo1_weigh" >Silo-1 Weigh </option>
                    <option value="silo2_weigh" selected="">Silo-2 Weigh </option>
                    <option value="silicate_tnk_114" >Silicate Storage Tank-1 </option>
                    <option value="silicate_tnk_124" >Silicate Storage Tank-2 </option>
                    <option value="sat1_ft_101" >Saturator-1 Inlet Flow </option>
                    <option value="sat1_sic_201" >Saturator-1 Polymer Dosing Pump Stroke</option>
  ...
  <tr class="tr6 table-secondary">      
                  ...
                  <select class="query form-control form-control-sm form-select" id="ufdata6" style="display: none;">
                    ...
                    <option value="cw_dosing_sp" >Lime Water Dosing Rate </option>
                    <option value="cw_alk_inlet" >CW Inlet Alkalinity </option>
                    <option value="sludge_tnk131" selected="">Lime Sludge Tank-1</option>
                    <option value="sludge_tnk231">Lime Sludge Tank-2</option>
                      </select>
                  </div> </div>
                 </td><td style="text-align: center;">
  ...
  <tr class="tr7 table-secondary">      
                  ...
                  <select class="query form-control form-control-sm form-select" id="ufdata7" style="display: none;">
                    ...
                    <option value="cw_alk_inlet" >CW Inlet Alkalinity </option>
                    <option value="sludge_tnk131" >Lime Sludge Tank-1</option>
                    <option value="sludge_tnk231" selected="">Lime Sludge Tank-2</option>
                  </select>
                  </div> </div>
                 </td><td style="text-align: center;">
