...
<title> TASI Saudi Stock Exchange </title>
</head>
...
<figure id="plot_window" class="test_print loading-msg" style="height:93vh;"></figure>
  ...
  <tr class="tr1 table-light">      
                  ...
                  <div class="col-auto"><input type="checkbox" class="query series-chk filter" id="line1" checked="">
                   &nbsp;1 &nbsp;<input type="color" id="pen1" name="pen1" value="#f9ca24" class="chart_render series-color"> &nbsp; </div>
                  <div class="col-auto"> 
  <select class="query form-control form-control-sm form-select" id="ufdata1">
    <option value="open_pv" selected>Open Price &nbsp;</option>
    <option value="high_pv">High Price   &nbsp;</option>
    <option value="low_pv">Low Price  &nbsp;</option>
    <option value="price_last_trade">Last Price   &nbsp;</option>
    <option value="vol_traded">Volume   &nbsp;</option>
    <option value="change_percent">Change %   &nbsp;</option>
    <option value="nb_trades">Number of Trades &nbsp;</option>
   </select>
                      </div>
  ...
  <div class="modal fade" id="modal1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-4">
      <input type="number" id="line_width1" class="chart_render rednder form-control" value="1" min="0" max="4" step="0.1">  
      </div>
    </div>
     <div class="row mb-2">
      <label for="marker1" class="col-sm-4 col-form-label">Marker Weight</label>
      <div class="col-sm-4">
      <input type="number" id="marker1" class="chart_render form-control" value="1.2" min="0" step="0.1" max="4"> 
      </div>
    </div>
     <div class="row mb-2">
  ...
  <tr class="tr2 table-light">      
                  ...
                  <div class="col-auto"><input type="checkbox" class="query series-chk filter" id="line2" checked=""> 
                    &nbsp;2 &nbsp;<input type="color" id="pen2" name="pen2" value="#27ae60" class="chart_render series-color"> &nbsp; </div>
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata2">
                    <option value="open_pv" >Open Price &nbsp;</option>
                    <option value="high_pv" selected>High Price   &nbsp;</option>
                    <option value="low_pv">Low Price  &nbsp;</option>
                    <option value="price_last_trade">Last Price   &nbsp;</option>
                    <option value="vol_traded">Volume   &nbsp;</option>
                    <option value="change_percent">Change %   &nbsp;</option>
  ...
  <div class="modal fade" id="modal-series2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="row mb-2">
      <label for="line_width1" class="col-sm-4 col-form-label">Line Width</label>
      <div class="col-sm-4">
      <input type="number" id="line_width2" class="chart_render form-control" value="1" min="0" max="4" step="0.1">  
      </div>
    </div>
     <div class="row mb-2">
      <label for="marker1" class="col-sm-4 col-form-label">Marker Weight</label>
      <div class="col-sm-4">
      <input type="number" id="marker2" class="chart_render form-control" value="1.2" min="0" step="0.1" max="4"> 
      </div>
    </div>
     <div class="row mb-2">
  ...
  <tr class="tr3 table-light">      
                  ...
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata3">
                    <option value="open_pv" >Open Price &nbsp;</option>
                    <option value="high_pv" >High Price   &nbsp;</option>
                    <option value="low_pv" selected>Low Price  &nbsp;</option>
                    <option value="price_last_trade">Last Price   &nbsp;</option>
                    <option value="vol_traded">Volume   &nbsp;</option>
                    <option value="change_percent">Change %   &nbsp;</option>
                    <option value="nb_trades">Number of Trades &nbsp;</option>
  ...
  <div class="modal fade" id="modal-series3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-4">
      <input type="number" id="line_width3" class="rednder form-control" value="1" min="0" max="4" step="0.1">  
      </div>
    </div>
     <div class="row mb-2">
      <label for="marker3" class="col-sm-4 col-form-label">Marker Weight</label>
      <div class="col-sm-4">
      <input type="number" id="marker3" class="chart_render form-control" value="1.2" min="0" step="0.1" max="4"> 
      </div>
    </div>
     <div class="row mb-2">
  ...
  <tr class="tr4 table-secondary">      
                  ...
                  <div class="col-auto"><input type="checkbox" class="query series-chk filter" id="line4" checked=""> 
                    &nbsp;4 &nbsp;<input type="color" id="pen4" name="pen4" value="#9b59b6" class="chart_render series-color" style="display: none;"> &nbsp; </div>
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata4" style="display: none;">
                    <option value="open_pv" >Open Price &nbsp;</option>
                    <option value="high_pv" >High Price   &nbsp;</option>
                    <option value="low_pv" >Low Price  &nbsp;</option>
                    <option value="price_last_trade" selected> Last Price &nbsp;</option>
                    <option value="vol_traded">Volume   &nbsp;</option>
                    <option value="change_percent">Change %   &nbsp;</option>
                    <option value="nb_trades">Number of Trades &nbsp;</option>
                  </select>
  ...
  <div class="modal fade" id="modal-series4" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-4">
      <input type="number" id="line_width4" class="chart_render form-control" value="1" min="0" max="4" step="0.1">  
      </div>
    </div>
     <div class="row mb-2">
      <label for="marker4" class="col-sm-4 col-form-label">Marker Weight</label>
      <div class="col-sm-4">
      <input type="number" id="marker4" class="chart_render form-control" value="1.2" min="0" step="0.1" max="4"> 
      </div>
    </div>
     <div class="row mb-2">
  ...
  <tr class="tr5 table-secondary">      
                  ...
                  <div class="col-auto"><input type="checkbox" class="query series-chk filter" id="line5" checked=""> 
                    &nbsp;5 &nbsp;<input type="color" id="pen5" name="pen5" value="#00cec9" class="chart_render series-color" style="display: none;"> &nbsp; </div>
                  <div class="col-auto"> 
                   <select class="query form-control form-control-sm form-select" id="ufdata5" style="display: none;">
                    ...
                    <option value="low_pv" >Low Price  &nbsp;</option>
                    <option value="price_last_trade" >Last Price   &nbsp;</option>
                    <option value="vol_traded" selected>Volume   &nbsp;</option>
                    <option value="change_percent">Change %   &nbsp;</option>
                    <option value="nb_trades">Number of Trades &nbsp;</option>
                      </select>
                  </div>  
  ...
  <div class="modal fade" id="modal-series5" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-4">
      <input type="number" id="line_width5" class="chart_render form-control" value="1" min="0" max="4" step="0.1">  
      </div>
    </div>
     <div class="row mb-2">
      <label for="marker5" class="col-sm-4 col-form-label">Marker Weight</label>
      <div class="col-sm-4">
      <input type="number" id="marker5" class="chart_render form-control" value="1.2" min="0" step="0.1" max="4"> 
      </div>
    </div>
     <div class="row mb-2">
  ...
  <tr class="tr6 table-secondary">      
                  ...
                  <div class="col-auto"><input type="checkbox" class="query series-chk filter" id="line6" checked=""> 
                    &nbsp;6 &nbsp;<input type="color" id="pen6" name="pen6" value="#e84393" class="chart_render series-color" style="display: none;"> &nbsp; </div> 
                  <div class="col-auto"> 
                  <select class="query form-control form-control-sm form-select" id="ufdata6" style="display: none;">
                    ...
                    <option value="price_last_trade" >Last Price   &nbsp;</option>
                    <option value="vol_traded" >Volume   &nbsp;</option>
                    <option value="change_percent" selected>Change %   &nbsp;</option>
                    <option value="nb_trades">Number of Trades &nbsp;</option>
                      </select>
                  </div> </div>
                 </td><td style="text-align: center;">
  ...
  <div class="modal fade" id="modal-series6" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-4">
      <input type="number" id="line_width6" class="chart_render form-control" value="1" min="0" max="4" step="0.1">  
      </div>
    </div>
     <div class="row mb-2">
      <label for="marker6" class="col-sm-4 col-form-label">Marker Weight</label>
      <div class="col-sm-4">
      <input type="number" id="marker6" class="chart_render form-control" value="1.2" min="0" step="0.1" max="4"> 
      </div>
    </div>
     <div class="row mb-2">
  ...
  <tr class="tr7 table-secondary">      
                  ...
                  <select class="query form-control form-control-sm form-select" id="ufdata7" style="display: none;">
                    ...
                    <option value="vol_traded" >Volume   &nbsp;</option>
                    <option value="change_percent" >Change %   &nbsp;</option>
                    <option value="nb_trades" selected>Number of Trades &nbsp;</option>
                  </select>
                  </div> </div>
                 </td><td style="text-align: center;">
  ...
  <div class="modal fade" id="modal-series7" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-4">
      <input type="number" id="line_width7" class="chart_render form-control" value="1" min="0" max="4" step="0.1">  
      </div>
    </div>
     <div class="row mb-2">
      <label for="marker7" class="col-sm-4 col-form-label">Marker Weight</label>
      <div class="col-sm-4">
      <input type="number" id="marker7" class="chart_render form-control" value="1.2" min="0" step="0.1" max="4"> 
      </div>
    </div>
     <div class="row mb-2">
  ...
  <nav class="navbar fixed-bottom navbar-expand-sm navbar-dark" style="background-color:rgba(0, 0, 0, 0.7); padding-top:2px; padding-bottom:0px;">
    ...
    <div class="col-auto" style="margin-right:3px;">
      <div class="input-group input-group-sm">
        ...
        <input type="date" name="start_date" class="tensor-flow form-control form-control-sm" id="start_date" value="2024-09-08" min="2016-01-01" max="2027-11-10" required="" style="background-color:#dff9fb;">
      </div>
    </div> </li>
    <li class="nav-item">
    <div class="col-auto" style="margin-right:3px;">
      <div class="input-group input-group-sm">
        ...
        <input type="date" name="end_date" id="end_date" value="2024-11-09" min="2016-01-31" max="2027-03-30" class="tensor-flow form-control form-control-sm" required="" style="background-color:#dff9fb;">
      </div>
    </div> </li>
    <li class="nav-item">
        <div class="col-auto" style="margin-right:3px;">
            <div class="input-group input-group-sm">
            <div class="input-group-text badge-light3d mnbtn" id="inputGroup-sizing-sm">Company</div>
            <select class="query form-control form-control-sm form-select" id="invt" style="background-color:#dff9fb;">
              <option value="SARCO" selected>SARCO</option>
              <option value="SAUDI ARAMCO" >SAUDI ARAMCO</option>
              <option value="PETRO RABIGH" >PETRO RABIGH</option>
              <option value="ARABIAN DRILLING" >ARABIAN DRILLING</option>    
              <option value="ADES" >ADES</option>  
              <option value="BAHRI" >BAHRI</option>
              <option value="ALDREES" >ALDREES</option>
              <option value="TAKWEEN" >TAKWEEN</option> 
              <option value="MEPCO" >MEPCO</option>
              <option value="BCI" >BCI</option> 
              <option value="MAADEN" >MAADEN</option> 
              <option value="ASLAK" >ASLAK</option> 
              <option value="ALYAMAMAH STEEL" >ALYAMAMAH STEEL</option> 
              <option value="SSP" >SSP</option> 
              <option value="EAST PIPES" >EAST PIPES</option> 
              <option value="AMAK" >AMAK</option> 
              <option value="CHEMANOL" >CHEMANOL</option> 
              <option value="SABIC" >SABIC</option> 
              <option value="SABIC AGRI-NUTRIENTS" >SABIC AGRI-NUTRIENTS</option> 
              <option value="TASNEE" >TASNEE</option> 
              <option value="NGC" >NGC</option> 
              <option value="ZOUJAJ" >ZOUJAJ</option> 
              <option value="ALUJAIN" >ALUJAIN</option> 
              <option value="FIPCO" >FIPCO</option> 
              <option value="APC" >APC</option>     
              <option value="AMIANTIT" >AMIANTIT</option> 
              </select>
            </div>
        </div> </li>
    <li class="nav-item">
  ...
  <script type="text/javascript" src="{{asset('js/stream/stocks_tasi_ksa.js') }}"></script>
