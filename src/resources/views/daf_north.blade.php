...
<figure id="plot_window" class="test_print loading-msg" style="height:93vh;"></figure>  
  ...
  <option value="a_flow">DAF 21A Flow   &nbsp;</option>
  <option value="a_pcv">DAF 21A PCV   &nbsp;</option>
  <option value="a_spray_pres">DAF 21A Balloon Pressure   &nbsp;</option>
  <option value="b_flow"> DAF 21B Flow  &nbsp;</option>
  <option value="b_pcv">  DAF 21B PCV &nbsp;</option>
  <option value="b_spray_pres"> DAF 21B Balloon Pressure  &nbsp;</option>
  <option value="c_flow">DAF 21C Flow   &nbsp;</option>
  <option value="c_pcv">DAF 21C PCV   &nbsp;</option>
  <option value="c_spray_pres"> DAF 21C Balloon Pressure  &nbsp;</option>
  <option value="d_flow"> DAF 21D Flow  &nbsp;</option>
  <option value="d_pcv"> DAF 21D PCV  &nbsp;</option>
  <option value="d_spray_pres"> DAF 21D Ballon Pressure  &nbsp;</option>
  <option value="e_flow"> DAF 21E Flow  &nbsp;</option>
  <option value="e_pcv"> DAF 21E PCV  &nbsp;</option>
  <option value="e_spray_pres"> DAF 21E Ballon Pressure  &nbsp;</option>
  <option value="f_flow">DAF 21F Flow   &nbsp;</option>
  <option value="f_pcv">DAF 21F PCV   &nbsp;</option>
  <option value="f_spray_pres">DAF 21F Ballon Pressure   &nbsp;</option>
  ...
  <option value="c_pcv">DAF 21C PCV   &nbsp;</option>
  <option value="c_spray_pres"> DAF 21C Balloon Pressure  &nbsp;</option>
  <option value="d_flow" selected=""> DAF 21D Flow  &nbsp;</option>
  <option value="d_pcv"> DAF 21D PCV  &nbsp;</option>
  <option value="d_spray_pres"> DAF 21D Ballon Pressure  &nbsp;</option>
  <option value="e_flow"> DAF 21E Flow  &nbsp;</option>
  <option value="e_pcv"> DAF 21E PCV  &nbsp;</option>
  ...
  <option value="d_pcv"> DAF 21D PCV  &nbsp;</option>
  <option value="d_spray_pres"> DAF 21D Ballon Pressure  &nbsp;</option>
  <option value="e_flow" selected=""> DAF 21E Flow  &nbsp;</option>
  <option value="e_pcv"> DAF 21E PCV  &nbsp;</option>
  <option value="e_spray_pres"> DAF 21E Ballon Pressure  &nbsp;</option>
  <option value="f_flow">DAF 21F Flow   &nbsp;</option>
  <option value="f_pcv">DAF 21F PCV   &nbsp;</option>
  ...
  <option value="e_pcv"> DAF 21E PCV  &nbsp;</option>
  <option value="e_spray_pres"> DAF 21E Ballon Pressure  &nbsp;</option>
  <option value="f_flow" selected="">DAF 21F Flow   &nbsp;</option>
  <option value="f_pcv">DAF 21F PCV   &nbsp;</option>
  <option value="f_spray_pres">DAF 21F Ballon Pressure   &nbsp;</option>
  <option value="daf_inletline_pres"> DAF Inlet Line Pressure &nbsp;</option>
  <option value="daf_inlet_tot_flow"> DAF Inlet Total Flow &nbsp;</option>
  ...
  <option value="c_flow">DAF 21C Flow   &nbsp;</option>
  <option value="c_pcv">DAF 21C PCV   &nbsp;</option>
  <option value="c_spray_pres" selected=""> DAF 21C Balloon Pressure  &nbsp;</option>
  <option value="d_flow"> DAF 21D Flow  &nbsp;</option>
  <option value="d_pcv"> DAF 21D PCV  &nbsp;</option>
  <option value="d_spray_pres"> DAF 21D Ballon Pressure  &nbsp;</option>
  <option value="e_flow"> DAF 21E Flow  &nbsp;</option>
  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-4">
      <input type="text" id="chr_title" name="chr_title" value="DAF North Line" class="chart_render">
    </div>
</div>
