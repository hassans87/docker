...
<body style="font-family: calibri;">
  ...
  <div class="input-group">
    ...
    <div class="col-auto" style="margin-right:5px;">
      ...
      <div class="input-group">
        <span class="btn badge-light3d btn-sm" data-bs-toggle="modal" data-bs-target="#sajid" style="margin-bottom:3px;">Global &nbsp;<i class="fa fa-wrench" aria-hidden="true" style="color:black;"></i></span>
      </div>
