...
<body>
  ...
  <style>
  @font-face {
    font-family: dotted_font;
    src: url(./../../_fonts/dotted-font/KGPrimaryDots.ttf);
  }
      ...
      <a href="{{ url('/home') }}"> 
          <button class="btn form-control btn-sm badge-light3d">Home &nbsp;<i class="fa fa-home" aria-hidden="true" style="color:black;"></i></button></a>
               ...
               <div class="col-auto" style="margin-right:5px;">
                  ...
                  <div class="input-group">
                  <span class="btn btn-sm badge-light3d" data-bs-toggle="modal" data-bs-target="#sajid" style="margin-bottom:3px;">Global Settings &nbsp; <i class="fa fa-wrench" aria-hidden="true" style="color:black;"></i></span>
                  </div>
          </div>
          <div class="col-auto" style="margin-right:8px;">
           ...
           <input type="date" name="start_date" class="tensor-flow form-control form-control-sm" id="start_date" value="2023-03-01" min="2016-01-01" max="2024-11-10" required="" style="background-color:#dff9fb;">
        </div>
        </div>
          <div class="col-auto" style="margin-right:5px;">
            <div class="input-group input-group-sm">
                ...
                <input type="date" name="end_date" id="end_date" value="2023-03-31" min="2016-01-31" max="2025-03-30" class="tensor-flow form-control form-control-sm" required="" style="background-color:#dff9fb;"> 
                </div>
          </div>
          <div class="col-auto" style="margin-right:5px;">
            <div class="input-group input-group-sm">
